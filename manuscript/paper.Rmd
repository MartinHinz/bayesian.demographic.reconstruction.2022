...
```{r p, dev='png', fig.show='hide', fig.height = 3, fig.width = 3, cache=TRUE}
...
|-----------------------------|--------------------------|-----------------|
| MeanSiteSize         | dpois(50)                            | ![MeanSiteSize](`r knitr::fig_chunk('dpois50', 'png')`)                |
| max_growth_rate      | dgamma(shape = 5, scale=0.05) + 1    | ![max_growth_rate](`r knitr::fig_chunk('dgammamaxgrowthrate','png')`) |
| mu_alpha             | dlnorm(1,sdlog=0.1)                  | ![mu_alpha](`r knitr::fig_chunk('mualpha','png')`)                    |
| a_alpha              | dexp(1)                              | ![a_alpha](`r knitr::fig_chunk('aalpha','png')`)                      |
| alpha                | dlnorm(mu_alpha[j],sdlog=a_alpha[j]) | ![alpha](`r knitr::fig_chunk('alpha','png')`)                         |
| p                    | ddirch(alpha[1:4])                   | ![p](`r knitr::fig_chunk('p','png')`)                                 |
| **Parameters**       |                                      |                                                                                |
| nEnd                 | 5                                    |                                                                                |
