...
The 'dates as data' or summed radiocarbon approach has contributed greatly to our understanding of prehistoric demography, but it is not without its critics [@attenbrow_hiscock_2015, @carleton_groucutt_2020]. While the methodology continues to evolve and to an extent accommodate these critiques [@crema_review_2022], there are certain essential problems that cannot be solved with methodological refinements in this area alone [@french_manifesto_2021, @schmidt_approaching_2021].<!-- [JR] What problems? -->
